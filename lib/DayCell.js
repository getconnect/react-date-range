...
var DayCell = (function (_Component) {
  ...
  _createClass(DayCell, [{
    ...
    value: function getStateStyles() {
      ...
      var isStartOfWeek = _props.isStartOfWeek;
      var isEndOfWeek = _props.isEndOfWeek;
      ...
      var todayStyle = isToday && !(isInRange || isSelected) ? styles['DayToday'] : {};
      var startOfWeekStyle = isStartOfWeek ? styles['DayStartOfWeek'] : {};
      var endOfWeekStyle = isEndOfWeek ? styles['DayEndOfWeek'] : {};
      var inRangeStartOfWeekStyle = isInRange && isStartOfWeek ? styles['DayInRangeStartOfWeek'] : {};
      var inRangeEndOfWeekStyle = isInRange && isEndOfWeek ? styles['DayInRangeEndOfWeek'] : {};
      var isSelectedStartOfWeekStyle = isSelected && isStartOfWeek ? styles['DaySelectedStartOfWeek'] : {};
      var isSelectedEndOfWeekStyle = isSelected && isEndOfWeek ? styles['DaySelectedEndOfWeek'] : {};

      return _extends({}, todayStyle, inRangeStyle, hoverStyle, passiveStyle, activeStyle, selectedStyle, startEdgeStyle, endEdgeStyle, startOfWeekStyle, endOfWeekStyle, inRangeStartOfWeekStyle, inRangeEndOfWeekStyle, isSelectedStartOfWeekStyle, isSelectedEndOfWeekStyle);
    }
  }, {
    key: 'getClassNames',
    value: function getClassNames() {
      ...
      var isStartOfWeek = _props2.isStartOfWeek;
      var isEndOfWeek = _props2.isEndOfWeek;
