  ...
  _createClass(Calendar, [{
    ...
    value: function renderDays() {
      ...
      return days.map(function (data, index) {
        ...
        var lastDayOfWeek = dayMoment.clone().day(firstDayOfWeek).add(6, 'days').day();
        ...
        var isStartOfWeek = firstDayOfWeek === dayMoment.day();
        var isEndOfWeek = lastDayOfWeek === dayMoment.day();
