...
var defaultTheme = {
  ...
  DaySelectedStartOfWeek: {},

  DayEndOfWeek: {},

  DayInRangeEndOfWeek: {},

  DaySelectedEndOfWeek: {},
...
exports['default'] = function () {
  ...
  return {
    ...
    DayStartOfWeek: _extends({}, defaultTheme.DayStartOfWeek, customTheme.DayStartOfWeek),

    DayInRangeStartOfWeek: _extends({}, defaultTheme.DayInRangeStartOfWeek, customTheme.DayInRangeStartOfWeek),

    DaySelectedStartOfWeek: _extends({}, defaultTheme.DaySelectedStartOfWeek, customTheme.DaySelectedStartOfWeek),

    DayEndOfWeek: _extends({}, defaultTheme.DayEndOfWeek, customTheme.DayEndOfWeek),

    DayInRangeEndOfWeek: _extends({}, defaultTheme.DayInRangeEndOfWeek, customTheme.DayInRangeEndOfWeek),

    DaySelectedEndOfWeek: _extends({}, defaultTheme.DaySelectedEndOfWeek, customTheme.DaySelectedEndOfWeek),
